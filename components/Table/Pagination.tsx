...
import { ButtonAsButtonProps } from "./types";
...
const Pagination = React.forwardRef<Ref, PaginationProps>(function Pagination(
  ...
  return (
    <div
      className="flex flex-col justify-between w-full text-xs text-gray-600 sm:flex-row dark:text-gray-400"
      ref={ref}
      {...other}
    >
      {/*
       ...
       */}
      <div className="flex items-center font-semibold tracking-wide uppercase">
